...
export interface Tenant {
  id: string;
  /**
   * This is the anme of the store (e.g Yuheng's store)
   */
  name: string;
  /**
  ...
  /**
   * Stripe Account ID for this store.
   */
...
export interface Product {
  ...
  image?: (string | null) | Media;
  refundPolicy?: ('1 day' | '7 days' | '14 days' | '30 days' | 'no-refund') | null;
  /**
...
export interface Order {
  ...
  /**
   * The ID of the Stripe account associated with this order.
   */
